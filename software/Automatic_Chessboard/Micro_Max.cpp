//  V3 October 2024, only add as Global the black_player_movement() for made the last move before CheckMate
//  V2 October 2024, only add a display for show the winner
// ******************************  INCLUDING FILES
#include "Arduino.h"
#include "Micro_Max.h"  

// La declaración extern simplemente le dice al compilador que el objeto existe y está definido en algún otro lugar
// (en este caso, en el archivo .ino). 
// De esta manera, el archivo .cpp puede usar el objeto lcd sin tener que definirlo nuevamente.

#include <LiquidCrystal_I2C.h> // V2 // verify is the same lab you have on .ino file
extern LiquidCrystal_I2C lcd; // V2

// Declaración de la función que está en el archivo .ino // V3
extern void black_player_movement();                      // V3
